...
pub trait IEventBetting<TContractState> {
    ...
    fn get_bet(self: @TContractState, user_address: ContractAddress) -> Array<EventBetting::UserBet>;
...
use akira_smart_contract::ERC20::ERC20Contract::IERC20ContractDispatcherTrait;
    ...
    use starknet::{
        ...
        get_block_timestamp, contract_address_const, syscalls
    };
    use super::super::super::ERC20::ERC20Contract;


    const BET_LIMIT: u256 = 100000000000000000000; //100 STARK
    #[storage]
    struct Storage {
        name: felt252,
        owner: ContractAddress,
        total_names: u128,
        bets: LegacyMap<felt252, Vec<UserBet>>,
        bets_count: u32,
